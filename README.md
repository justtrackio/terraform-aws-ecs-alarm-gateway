...
| <a name="input_alarm_priority_high"></a> [alarm\_priority\_high](#input\_alarm\_priority\_high) | Whether to create a high priority alarm | `string` | `"high"` | no |
| <a name="input_alarm_priority_warning"></a> [alarm\_priority\_warning](#input\_alarm\_priority\_warning) | Whether to create a warning priority alarm | `string` | `"warning"` | no |
...
| <a name="input_datapoints_to_alarm"></a> [datapoints\_to\_alarm](#input\_datapoints\_to\_alarm) | The number of datapoints that must be breaching to trigger the alarm | `number` | `3` | no |
...
| Name | Description |
|------|-------------|
| <a name="output_alarm_arns"></a> [alarm\_arns](#output\_alarm\_arns) | A map of CloudWatch metric alarm ARNs keyed by alarm level |
| <a name="output_alarm_ids"></a> [alarm\_ids](#output\_alarm\_ids) | A map of CloudWatch metric alarm IDs keyed by alarm level |
| <a name="output_alarm_names"></a> [alarm\_names](#output\_alarm\_names) | A map of CloudWatch metric alarm names keyed by alarm level |
<!-- END_TF_DOCS -->
